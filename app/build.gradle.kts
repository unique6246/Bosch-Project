...
android {
    ...
    sourceSets {
        getByName("main").assets.srcDirs("src/main/assets") // Specify assets directory location
    }
...
dependencies {
    ...
    implementation ("com.google.ar:core:1.43.0") // ARCore library for augmented reality
    implementation("androidx.constraintlayout:constraintlayout:2.1.4") // ConstraintLayout for flexible UI design
    implementation("com.google.ar.sceneform.ux:sceneform-ux:1.17.1") // Sceneform UX library for AR
    implementation("com.google.ar.sceneform:assets:1.17.1") // Sceneform assets library for AR
